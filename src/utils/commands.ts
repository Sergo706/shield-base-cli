export const commands = {
  acceptFireholRisk: {
    ...
    useragent: { type: 'boolean', description: 'Compile suspicious HTTP user-agent patterns into an LMDB database' },
    email: { type: 'boolean', description: 'Compile disposable email domain blocklist into an LMDB database' },
    ja4: { type: 'boolean', description: 'Compile community-maintained JA4+ fingerprints into an LMDB database' },
...
export const sources = [
      ...
      { label: 'UserAgent', value: 'UserAgent', hint: '🕵️ Suspicious HTTP user-agent patterns compiled into an LMDB database' },
      { label: 'Email', value: 'Email', hint: '📧 Disposable email domain blocklist compiled into an LMDB database' },
      { label: 'JA4', value: 'JA4', hint: '💻 Community-maintained JA4+ fingerprints compiled into an LMDB database' },
