export const commands = {
  acceptFireholRisk: {
    ...
    useragent: { type: 'boolean', description: 'Download suspicions useragent csv' },
    email: {type: 'boolean', description: 'Download a list of disposable email domains txt'},
    ja4: {type: 'boolean', description: 'Download a json database of community maintained JA4+ fingerprints'},
...
export const sources = [
      ...
      { label: 'UserAgent', value: 'UserAgent', hint: '🕵️ Suspicious HTTP user-agent strings CSV' },
      { label: 'Email', value: 'Email', hint: '📧 Disposable email domain blocklist' },
      { label: 'JA4', value: 'JA4', hint: '💻 Community maintained JA4+ fingerprints with over 240mb of data' },
